...
how large-scale software are structured (I read a lot of LLVM source code LOL), and how programming languages are
...
- Steal design from other languages such as Zig, Rust, Carbon, Python, C#, ...
...
|--------------------------------------|-----------------------------------------------|
| Some README files in the source code | Search under src                              | 
