...
TEST(tokenize, general_test1) {
  ...
  std::vector<std::pair<std::string, TT>> expected =
      {std::pair("#", TT::PUNCTUATION), std::pair("build_msg", TT::ID), std::pair(":", TT::PUNCTUATION),
       ...
       std::pair("argc", TT::ID), std::pair("*", TT::BOP), std::pair("sizeof", TT::ID), std::pair("(", TT::PUNCTUATION),
       std::pair("*", TT::BOP), std::pair("str", TT::KEYWORD), std::pair(")", TT::PUNCTUATION),
       std::pair(")", TT::PUNCTUATION), std::pair(")", TT::PUNCTUATION), std::pair(";", TT::PUNCTUATION),
       std::pair(" this is redundant, but for illustration purposes", TT::COMMENTS), std::pair("for", TT::KEYWORD),
       std::pair("(", TT::PUNCTUATION), std::pair("i", TT::ID), std::pair(":", TT::PUNCTUATION),
       std::pair("u32", TT::KEYWORD), std::pair("=", TT::BOP), std::pair("0", TT::INT), std::pair(";", TT::PUNCTUATION),
       std::pair("i", TT::ID), std::pair("<", TT::RELOP), std::pair("argc", TT::ID), std::pair(";", TT::PUNCTUATION),
       std::pair("i", TT::ID), std::pair("+=", TT::BOP), std::pair("1", TT::INT), std::pair(")", TT::PUNCTUATION),
       std::pair("{", TT::PUNCTUATION), std::pair("args", TT::ID), std::pair("[", TT::PUNCTUATION),
       std::pair("i", TT::ID), std::pair("]", TT::PUNCTUATION), std::pair("=", TT::BOP), std::pair("argv", TT::ID),
       std::pair("[", TT::PUNCTUATION), std::pair("i", TT::ID), std::pair("]", TT::PUNCTUATION),
       ...
       std::pair(":", TT::PUNCTUATION), std::pair("u32", TT::KEYWORD), std::pair("=", TT::BOP), std::pair("0", TT::INT),
       std::pair(";", TT::PUNCTUATION), std::pair("i", TT::ID), std::pair("<", TT::RELOP), std::pair("argc", TT::ID),
       std::pair(";", TT::PUNCTUATION), std::pair("i", TT::ID), std::pair("+=", TT::BOP), std::pair("1", TT::INT),
       std::pair(")", TT::PUNCTUATION), std::pair("{", TT::PUNCTUATION), std::pair("if", TT::KEYWORD),
       std::pair("(", TT::PUNCTUATION), std::pair("args", TT::ID), std::pair("[", TT::PUNCTUATION),
       std::pair("i", TT::ID), std::pair("]", TT::PUNCTUATION), std::pair("==", TT::RELOP), std::pair("-v", TT::STRING),
       std::pair("||", TT::RELOP), std::pair("args", TT::ID), std::pair("[", TT::PUNCTUATION), std::pair("i", TT::ID),
       ...
       std::pair(";", TT::PUNCTUATION), std::pair("}", TT::PUNCTUATION), std::pair("if", TT::KEYWORD),
       std::pair("(", TT::PUNCTUATION), std::pair("args", TT::ID), std::pair("[", TT::PUNCTUATION),
       std::pair("i", TT::ID), std::pair("]", TT::PUNCTUATION), std::pair("==", TT::RELOP), std::pair("-h", TT::STRING),
       std::pair("||", TT::RELOP), std::pair("args", TT::ID), std::pair("[", TT::PUNCTUATION), std::pair("i", TT::ID),
       std::pair("]", TT::PUNCTUATION), std::pair("==", TT::RELOP), std::pair("--help", TT::STRING),
       std::pair(")", TT::PUNCTUATION), std::pair("{", TT::PUNCTUATION), std::pair("print", TT::ID),
       std::pair("(", TT::PUNCTUATION), std::pair("Avaiable options:\\n", TT::STRING), std::pair(")", TT::PUNCTUATION),
       std::pair(";", TT::PUNCTUATION), std::pair("println", TT::ID), std::pair("(", TT::PUNCTUATION),
